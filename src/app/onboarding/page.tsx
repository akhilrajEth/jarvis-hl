    ...
    >
        ...
        >
          <Box
            sx={{
              ...
              height: 40,
              borderRadius: "50%",
              background: Number(step) === 0 ? "#73F4C9" : "#333",
              color: Number(step) === 0 ? "#222" : "#b3b3b3",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              fontWeight: 700,
          ...
          <Box
            sx={{
              ...
              height: 40,
              borderRadius: "50%",
              background: Number(step) === 1 ? "#73F4C9" : "#333",
              color: Number(step) === 1 ? "#222" : "#b3b3b3",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              fontWeight: 700,
      ...
      {step === 0 && (
        <Box sx={{ position: "absolute", top: 60, left: 32 }}>
          <Typography
            variant="h4"
            sx={{ fontWeight: 700, color: "var(--color-foreground)" }}
          >
